          ...
          <div className="bigbox-courses">
              <div className="box1-courses">
                  <div className="box1d-courses" />
                      ...
                      <div className='view1-ct'>
                        <Button 
                            variant="secondary" 
                            onClick={() => navigate("/CoursesIntrotoMathStudent")} 
                            style={{
                            color: '#302929',
                            fontSize: 32,
                      ...
                      <div className='update1-ct'>
                        <Button 
                            variant="secondary" 
                            onClick={() => navigate("/BrowseLessonIntrotoMath")} 
                            style={{
                            color: '#ffffff',
                            fontSize: 32,
                            fontFamily: 'sans-serif',
              ...
              <div className="box2-courses">
                  <div className="box1d-courses" />
                      ...
                      <div className='view1-ct'>
                        <Button 
                            variant="secondary" 
                            onClick={() => navigate("/CoursesQuantiMethodStudent")} 
                            style={{
                            color: '#302929',
                            fontSize: 32,
                            fontFamily: 'sans-serif',
              ...
              <div className="box3-courses">
                  <div className="box1d-courses" />
                      ...
                      <div className='update1-ct'>
                        <Button 
                            variant="secondary" 
                            onClick={() => navigate("/BrowseLessonIntroTeacher")} 
                            style={{
                            color: '#ffffff',
                            fontSize: 32,
                            fontFamily: 'sans-serif',
