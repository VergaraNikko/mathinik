            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginLeft: 900, marginRight: 20, flexDirection: 'column' }}>
                <div style={{ textAlign: 'right', marginRight: 10 }}>
                    ...
                    <div className="overlap-6">
                        ...
                        <div className="text-wrapper-6">View Quiz</div>
                    </div>
                ...
                <div className="gray-box1-wq">
                    ...
                    />
                    <div className="circle-wq"/>
                </div>

                <div className="gray-box2-wq">
                    <p className='q1-cq'> Question 2</p>
                    <Input
                        value={question}
                        onChange={(e) => setQuestion(e.target.value)}
                        placeholder="149 * 239"
                ...
                <div className="gray-box3-wq">
                    <p className='q1-cq'> Question 3</p>
                    <Input
                        value={question}
                        onChange={(e) => setQuestion(e.target.value)}
                        placeholder="780 / 40"
