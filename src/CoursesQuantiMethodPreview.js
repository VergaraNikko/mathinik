...
const CoursesQuantiMethodPreview = () => {
          ...
          <div className="overlap-6-courses">
            ...
            <div className="bigbox-courses-cim">
              ...
              <div className="box10-courses">
                ...
                <div className='gray-box-quanti'>
                    <div className="remove-bl-cim" style={{ gap: '30px', marginRight: '50px', marginTop: '5px' }}>
                    <Button variant="outlined" onClick={() => navigate("/BrowseCourses")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '50px', border: '2px solid #d9d9d9', backgroundColor: '#ef1212' }}>X</Button>
                    </div>

                    <div className='title-lesson-cim'>Quantitative Methods</div>
                    <p className="topic1-cim">
                        <span className="topic-lesson-cim">Topic 1 : Regression Analysis</span> <br/>
                        <span className="about-lesson-cim">* Simple linear regression</span><br/>
                        <span className="about-lesson-cim">* Multiple regression analysis</span> <br/><br/>
                        <span className="topic-lesson-cim">Topic 2 : Time Series Analysis</span><br/>
                        <span className="about-lesson-cim">* Arima Modeling</span><br/>
                        <span className="about-lesson-cim">* Exponential smoothing methods</span><br/><br/>
                        <span className="topic-lesson-cim">Topic 3 : Experimental Design</span><br/>
                        <span className="about-lesson-cim">* Factorial Design</span><br/>
                        <span className="about-lesson-cim">* Randomized control trials</span><br/><br/>
                        <span className="topic-lesson-cim">Topic 4 : Survey Sampling</span><br/>
                        <span className="about-lesson-cim">* Stratefied sampling</span><br/>
                        <span className="about-lesson-cim">* Cluster sampling</span><br/><br/>
                        <span className="topic-lesson-cim">Topic 5 : Hyphotesis Testing</span><br/>
                        <span className="about-lesson-cim">* Parametric vs non-parametric testing</span><br/>
                        <span className="about-lesson-cim">* Type I and Type II errors</span><br/>
                    </p>
                </div>
...
export default CoursesQuantiMethodPreview;
