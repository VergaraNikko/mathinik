...
const CoursesQuantiMethodStudent = () => {
            ...
            <div className="bigbox-courses-cim">
              ...
              <div className="box10-courses">
                ...
                <div className='gray-box-quanti'>
                    ...
                    <Button variant="outlined" onClick={() => navigate("/Courses")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '50px', border: '2px solid #d9d9d9', backgroundColor: '#ef1212' }}>X</Button>
                    </div>
...
export default CoursesQuantiMethodStudent;
