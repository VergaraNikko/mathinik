...
const BrowseLessonIntroTeacher = () => {
        ...
        <div style={{ textAlign: 'right', marginRight: 10 }}>
          ...
          <div className="browse-lesson-bl">
                ...
                <div className="remove-bl" style={{ gap: '30px', marginRight: '50px', marginTop: '5px' }}>
                  <Button variant="outlined" onClick={() => navigate("/DashboardTeacher")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '50px', border: '2px solid #d9d9d9', backgroundColor: '#ef1212' }}>X</Button>
                </div>
                ...
                <div className="Buttons-Course" style={{ gap: '30px', marginTop: 830 }}>
                  <Button variant="outlined" onClick={() => navigate("/EditLesson")} style={{ color: '#ffffff', fontSize: 18, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #0b7077cc', background: '#fd661f' }}>Edit Lesson</Button>
                  <Button variant="outlined" onClick={() => navigate("/CreateQuiz")} style={{ color: '#ffffff', fontSize: 18, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #fd661f', background: '#0b7077cc' }}>Add a Quiz</Button>
                  <Button variant="outlined" onClick={() => navigate("/ViewQuiz")} style={{ color: '#fd661f', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #d9d9d9', background: '#d9d9d9', textDecoration: 'underline' }}>View Quiz</Button>
...
export default BrowseLessonIntroTeacher;
