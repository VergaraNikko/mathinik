          ...
          {/* Your Service content can go here */}
            ...
            <div className="white-box1-tq">
                <div className='greenbox-tq'>
                    <div className='q1-tq1'>Question 2 :</div>
                    <div className='q2-tq1'>129 + 37 =</div>
                </div>
                <div className='orangebox-tq'>
                    <div className='choices-tq1'>Choose Answer :</div>
                    <Button variant="secondary" onClick={handleCorrectAnswer} style={{ color: '#ffffff', fontSize: 48, fontFamily: 'sans-serif', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', width: "20px", height: 50, top: 50, left: 80 }}>4,773</Button>
                    <Button variant="secondary" onClick={handleIncorrectAnswer} style={{ color: '#ffffff', fontSize: 48, fontFamily: 'sans-serif', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', width: "20px", height: 50, top: 130, left: 60 }}>4,775</Button>
                    <Button variant="secondary" onClick={handleIncorrectAnswer} style={{ color: '#ffffff', fontSize: 48, fontFamily: 'sans-serif', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', width: "20px", height: 50, top: 190, left: 110 }}>3,734</Button>
                    <Button variant="secondary" onClick={handleIncorrectAnswer} style={{ color: '#ffffff', fontSize: 48, fontFamily: 'sans-serif', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', width: "20px", height: 50, top: 70, left: 80 }}>3,773</Button>
                
                    <Button variant="outlined" onClick={() => navigate("/TakeQuiz3")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', background: '#0b7077', width: "190px", height: 50, top: 270, left: -30 }}>NEXT</Button>
                </div>
                <Button variant="outlined" onClick={() => navigate("/TakeQuiz1")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', background: '#0b7077', width: "190px", height: 50, top: 460, left: -260 }}>PREVIOUS</Button>
